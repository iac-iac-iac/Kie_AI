...
import { useModelSchema } from "../hooks/useAudioModels";
...
export function GenerationPanel({
  ...
  useGenerationPoll(activeGenerationId, "audio");
    ...
    <div className="relative flex min-h-0 flex-1 flex-col">
      ...
      <div className="flex min-h-0 flex-1 flex-col">
          ...
          {schemaQuery.data && (
            <div className={!hasApiKey ? "pointer-events-none select-none opacity-40" : undefined}>
              ...
              <DynamicModelForm
                ...
                uploadLabelsKey="audio"
                promptPlaceholderKey="audio.promptPlaceholder"
              />
            </div>
          )}
        ...
        <div className="space-y-3 border-t border-[var(--glass-border)] p-4">
          ...
          >
            {isGenerating ? t("audio.generating") : t("audio.generate")}
          </Button>
        </div>
      </div>
    </div>
